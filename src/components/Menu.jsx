                    ...
                    </div>
                    {
                        showAll ? <div className='categories-container'>{categories.map((items, index) => (
                            <Bounce left key={index}>
                                <div style={{ position: 'relative', margin: '30px 0' }} className='px-3'>
                            ...
                            <div className='categories-container px-3' >
                                {state.map((item, index) => (
                                    <div className={ease ? "ease" : "noEase categories-container"} key={index}>
                                        ...
                                        <div className='action'>
                                            <div className="action-container" onClick={() => addToCart(item)}>
                                                <div className='action-sub-container '>
                                                    <AddShoppingCart />
                                                </div>
                                            </div>
